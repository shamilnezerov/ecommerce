...
const CollapsData = ({ getProduct, products, deleteProduct, editProd }) => {
  ...
  const genExtra = (id) => (
    <div className="d-flex align-items-center">
      ...
      <Button
        ...
        className="d-flex me-2 justify-content-center align-items-center"
        shape="circle"
      >
        <EditFilled />
      </Button>
  ...
  return (
    <>
      <Collapse onChange={onChange} expandIconPosition={expandIconPosition}>
        {products.map(
          (
            {
              name,
            ...
            return (
              ...
              >
                ...
                <div>
                  {" "}
                  <b>Global Raiting;</b> {global_rating}
                </div>
                <div>
                  <b>Local Raiting:</b> {local_rating}
                </div>
